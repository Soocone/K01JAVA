...
class Avengers {
	...
	public boolean equals(Object obj) {
		...
		return Objects.equals(name, other.name)	&& 
				Objects.equals(heroName, other.heroName) && 
...
public class QuHashSet {
	...
	public static void main(String[] args) {
		...
		Iterator<Avengers> itrSet = set.iterator();
		
		while(itrSet.hasNext()) {
			Avengers av = itrSet.next();
			
			if(av.name.equals(searchName)) {
				System.out.println("검색 결과: "+av.toString());
				searchBool = true;
			}
		}
		if(searchBool==false)
			System.out.println("해당 영웅은 없어용,,");
	}
}
