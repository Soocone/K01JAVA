...
public class Ex03ArrayList1
{
	public static void main(String[] args)
	{
		...
		/*
		 Iterator 사용법
		 1. 컬렉션에 저장된 내용을 Iterator에 알려주기 위해 객체를 생성한다.
		...
		System.out.println(list.contains("블랙핑크") ? "블랙핑크" : "블랙핑크 없음");
		...
		/*
		 방법3: 인스턴스(객체)의 참조값("방탄소년단")을 통해 삭제한다.
		 		이 경우 삭제에 성공하면 true가 반환된다.
		 */
		System.out.println(list.remove("방탄소년단") ? "삭제 성공(BTS)" : "삭제 실패(BTS)");
		//삭제할 객체가 없더라도 에러가 발생하지는 않는다.
		System.out.println(list.remove("오마이걸") ? "삭제 성공(OMG)" : "삭제 실패(OMG)");
