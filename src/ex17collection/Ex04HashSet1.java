...
public class Ex04HashSet1
{
	public static void main(String[] args)
	{
		...
		int number = 100; //정수타입은 컬렉션에 저장시 Integer 객체로 Boxing된다.
		...
		/*
		 5-2] 개발자가 정의한 객체 중복저장
		 	: 사용자정의 클래스인 경우 hashCode, equals 메서드를
		 ...
		 */
		System.out.println(set.contains(strObject1) ? "strObject1 있다" : "strObject1 없");
		System.out.println(set.contains("JAVA") ? "JAVA 있다" : "JAVA 없");
