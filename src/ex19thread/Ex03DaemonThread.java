...
/*
 종속 쓰레드(Daemon Thread)
 	...
 	주로 프로그램의 보조역할로 배경음악, 로그 자동저장 등의 업무를 처리한다.
	...
	public void run()
	{
		while(true) {
			...
			try {
				...
				System.out.println("자동 저장시 오류발생 ㅜㅜ");
			}
		}
	}
}
...
public class Ex03DaemonThread
{
	public static void main(String[] args)
	{
		...
		nt2.notThreadMethod();
		//1번 객체가 작업을 끝내야만 2번 객체가 실행된다. 즉 순차실행된다.
		...
		//Thread 클래스의 정적메서드를 통해 여러가지 정보 확인
