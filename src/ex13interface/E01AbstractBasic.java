...
class AbsClassChild2 extends AbsClass2{
	...
	void newMethod() {
		System.out.println("자식클래스에서 새롭게 확장한 메서드");
	}
}
...
public class E01AbstractBasic
{
	public static void main(String[] args)
	{
		...
		/*
		 ...
		 사용하는 것은 가능하다.
		 */
		AbsClass2 absCalss2 = new AbsClassChild2();
		absCalss2.absMethod(100);
		//부모타입으로 자식객체에 접근하려면 다운캐스팅 해야한다.
		((AbsClassChild2)absCalss2).newMethod();
		
		/*
		 추상클래스 내에서 선언된 정적멤버메서드는 오버라이딩의 대상이
		 아니므로 static의 기본규칙을 따른다. 즉 클래스명으로 접근하면 된다.
		 */
