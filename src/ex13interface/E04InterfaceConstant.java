...
/*
 인터페이스에 변수를 정의하면 무조건 상수가 되므로 주로 "인터페이스형 상수"
 라고 표현한다. 주로 설정값이나 명시적인 코드를 위해 사용된다.
 가위,바위,보를 1,2,3이 아닌 Game.SCISSORS 라고 표현하는 것처럼 명시적이 됨.
 */
interface Game{
...
public class E04InterfaceConstant
{
	public static void main(String[] args)
	{
		...
		switch(sel) {
		/*
		 가위 바위 보를 1,2,3으로 설정했지만 설정값이 많은 경우 기억하기 
		 힘들 수 있으므로 명시적인 단어를 통한 상수를 사용하는 것이 좋다.
		 */
		case Game.SCISSORS:
