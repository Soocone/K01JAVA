...
//개발자 정의 예외 클래스
class WrongNumberException_t extends Exception {
	public WrongNumberException_t()
	{
		super("[예외발생]숫자를 잘못 입력했습니다.");
	}
}

public class RockPaperScissorsException_t
{
	public static void main(String[] args)
	{
		...
		while(true) {			
			...
			try {
				...
				if(user<1 || user>3) {
					WrongNumberException_t wne = new WrongNumberException_t();
					throw wne;
				}
			}
			...
			catch (WrongNumberException_t e) {
