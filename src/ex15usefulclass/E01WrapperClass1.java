...
public class E01WrapperClass1
{
	public static void main(String[] args)
	{
		...
		Integer n20Obj = new Integer(num2); //디플리케이트(deprecated)되었다.(사라졌다)
		...
		/*
		 ...
		 오토박싱 혹은 오토언박싱이 지원되므로 기본자료형 변수를 선언하는 것과
		 동일하게 기술할 수 있다.
		 */
		Integer numObj1 = 100;
		Integer numObj2 = 200;
		...
		/*
		 Wrapper클래스를 통해 진법변환이나 해당 자료형의 최대/최소값을
		 알 수 있다.
		 */
		...
		/*
		 ...
		 toString(): 인스턴스 변수를 출력할 때 참조값이 아니라 실제
		 	저장된 값을 문자열로 반환해주는 메서드
