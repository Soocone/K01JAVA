...
/*
 컴퓨터를 상속한 노트북 컴퓨터
 	: 컴퓨터가 가지고 있는 기본 기능에 휴대 이용 부분을 확장하여
 	정의한다. 휴대 이용을 위해 배터리 멤버변수가 추가된다.
 */
class NotebookComputer extends Computer{
	
	//자식 클래스에서 확장한 변수(배터리를 표현)
	int battary;
	...
	public NotebookComputer(String name, int initCharge) {
		/*
		 ...
		 인자가 있는 타입인 인자생성자를 정의하였으므로 디폴트 생성자는 
		 만들어지지 않기 때문이다.
		 */
		super(name);
		battary = initCharge;
...
/*
 태블릿 노트북: 컴퓨터의 기본인 계산 기능, 휴대이용 기능, 여기에
	...
	public void write(String penInfo) {
		...
		/*
		 A.compareTo(B)
		 	...
		 	-1이나 1이 반환되면 서로 다른 문자열로 판단하는 String 클래스에
		 	정의된 메서드.
		 */
