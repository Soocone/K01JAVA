...
public class E01JunsuType {
	...
	public static void main(String[] args) {
		/*
		 ...
		 - 각 자료형의 표현 범위는 교안을 참조한다(외울 필요 없음)
		 - 일반적으로 cpu(중앙처리장치)는 정수형 연산을 할 때 int형을
		   가장 빠르게 처리한다.
		 - 즉, 정수현 변수를 쓸 때는 거의 대부분 int형을 사용한다.
		 */
		...
		/*
		 ...
		 / 연산자는 두 정수를 나눠서 나온 몫을 구하는 연산자이므로 결과는 0이 나온다.
		 */
		result1 = int1 / int2;
		...
		/*
		 ...
		 - byte, short 형은 게임캐릭터의 움직임이나 음원정보 등을 표현할 때 주로 사용된다.
		 */
		...
		/*
		 ...
		 - 단, byte 형과 short형은 예외적인 상황으로 생각하면 된다.
		   int형에 최적화된 cpu의 특성 때문이다.		 
		 */
		...
		/*
		 ...
		 이 때는 접미사(L or l)을 붙여서 int형 자료가 아닌 long형 자료임을 
		 알려줘야 한다.
		 이와 같이 대입을 위해 입력되는 숫자도 자료형을 기반으로 메모리에 
		 저장되고, 이를 '리터럴(literal)'이라고 한다.
		 */
		//long long3 = 2200000000;  => 에러 발생 됨.
