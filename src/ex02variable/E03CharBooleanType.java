...
public class E03CharBooleanType {
	...
	public static void main(String[] args) {
		...
		String chStr = "가나다라";  //이렇게 String으로 선언해야함
		...
		char ch4_1 = '1' + 1;  //숫자가 아니라 문자 1이므로 49(아스키)로 저장된다. 49+1
		System.out.println("ch4="+ ch4
				+", ch4_1="+ ch4_1
				+", ch4_1="+ (int)ch4_1);  // 숫자 50, 문자 2가 출력됨
		...
		/*
		 &&(논리 And): 엠퍼센트. 양쪽 모두 참일때만 참을 반환하는 연산자.
		 	그 외에는 모두 거짓을 반환한다.
		 	
		 ||(논리 Or): 파이프. 둘 중 하나만 참이어도 참을 반환하는 연산자.
		 	둘 다 거짓일 경우에만 거짓을 반환한다.
		 */
		boolean bn3 = bn1 && bn2;
