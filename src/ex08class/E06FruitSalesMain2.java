...
class FruitBuyer2{
	...
	//FruitSeller2타입의 seller참조변수 사용(주소값 하나가 seller라고 전달된것일뿐임)
...
public class E06FruitSalesMain2
{
	public static void main(String[] args)
	{
		...
		FruitSeller2 seller1 = new FruitSeller2(); //판매자 객체 생성
		seller1.initMembers(0, 100, 1000);
		
		//판매자2: 사과 80개, 단가 500원
		FruitSeller2 seller2 = new FruitSeller2(); //판매자 객체 생성
		seller2.initMembers(0, 80, 500);
		
		//구매자: 보유금액 10000원
		FruitBuyer2 buyer = new FruitBuyer2();  //구매자 객체 생성
		...
		/*
		 buyer가 buyApple을 할건데 seller에게 5000원을 주고.
		 구매자가 판매자1, 2에게 각각 5000원을 지불하고 사과 구매
		 */
