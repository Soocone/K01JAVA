...
class FruitBuyer{
	 ...
	 */
	//FruitSeller타입의 seller참조변수 사용(주소값 하나가 전달된것일뿐임)
...
public class E06FruitSalesMain1
{
	...
	{
		FruitSeller seller = new FruitSeller(); //판매자 객체 생성
		FruitBuyer buyer = new FruitBuyer();  //구매자 객체 생성
